...
{
	partial class DefinitionUpdatesAvailableWindow
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.ControlBorderedPanel.TabIndex = 20;
			...
			this.label5.Text = "For firmwares:";
			// 
			// ChangesTextBox
			// 
			...
			this.ChangesTextBox.TabIndex = 22;
			// 
			// AvailableLable
			// 
			...
			this.AvailableLable.TabIndex = 21;
			this.AvailableLable.Text = "New definitions";
			// 
			// DefinitionUpdatesAvailableWindow
			// 
			...
			this.Name = "DefinitionUpdatesAvailableWindow";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "NFirmwareEditor - New Definitions";
